                                                    ...
                                                    <tr>
                                                        <td valign="top" class="bodyContent">
                                                            <div mc:edit="std_content00">
                                                                <h1 class="h1">Actualizacion de Compra </h1>
                                                                
                                                                <strong style="color: black">¡Hola <?php echo e($order->email); ?></strong>
                                                                Se actualizó informacion de tu compra verifica los datos
                                                            </div>
                                                    </tr>
                                                    <tr>
	                                                 		...
	                                                 		<tr>
	                                                 			<td valign="top" class="bodyContent">
	                                                 				<div mc:edit="std_content01">
	                                                 					Si algun dato esta mal comunicate a <a href="mailto:ayuda@nahel.com">ayuda@nahel.com</a>
	                                                 				</div>
	                                                 			</td>
	                                                 		</tr>
                                                            	...
                                                            	<tr>
                                                                	<td valign="middle" class="templateButtonContent">
                                                                    	<div mc:edit="std_content02">
                                                                        	<a style="color: #FFFFFF" href="<?php echo e(url('/compras/'.$order->shoppingCartID())); ?>" target="_blank">Ver más información</a>
                                                                        </div>
                                                                    </td>
                                                                </tr>
                                                            </table>
                                                    ...
                                                    <tr>
                                                        <td valign="top">
                                                            <div mc:edit="std_footer">
																<em>Copyright &copy; 2017 Nahel, All rights reserved.</em>
																<br />
																<br />
																<strong>Nuestra direccion de correo es:</strong>
																<br />
																ayuda@nahel.com 
                                                            </div>
                                                        </td>
